# Import file "Jason_Podcast_Framer_Export" (sizes and positions are scaled 1:2)
sketch = Framer.Importer.load("imported/Jason_Podcast_Framer_Export@2x")
...
# Header Menu
layerJ = sketch.HeaderMenu
# Episode Stuff
layerK = sketch.MainPretty
layerL = sketch.Main
# Recap
layerM = sketch.ReadMenu
